...
//    public static final String keyServer = "http://192.168.1.38/connect_get_user.php";
    ...
    private void deleteAllData() {
        SQLiteDatabase objSqLiteDatabase = openOrCreateDatabase("restaurant_v2.db", MODE_PRIVATE, null);
    ...
    private void synJSONtoSQLite() {
        ...
        try {
            ...
            HttpPost objHttpPost = new HttpPost("http://192.168.1.38/connect_get_user.php");
